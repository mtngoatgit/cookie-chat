angular.module('chatroom').controller('mainCtrl', function($scope, messageService){
  ...
  //your controllers $scope as messages ($scope.messages)
      ...
      $scope.getMessages = function(){
        messageService.getData().then(function(result){
          $scope.messages = result.data.chats
        })
      }
...
// $scope.getMessages = function (){
//         messageService.getData().then(function (results) {
//           $scope.messages = results.data.chats;
//         });
//     }